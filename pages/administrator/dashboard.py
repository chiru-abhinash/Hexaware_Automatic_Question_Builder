...
def show_admin_dashboard():
    ...
    selected_option = option_menu(
        ...
        options=["User Management", "Add User", "System Monitoring", "Report Generation", 
                 "Settings", "Issue Resolution", f"Notifications ({unread_count} new)", "Logout"],
        icons=["people", "person-plus", "activity", "file-earmark-text", "gear", "exclamation-circle", "bell", "box-arrow-right"],
        menu_icon="cast", 
        default_index=0, 
    ...
    elif selected_option == "System Monitoring":
        show_system_monitoring_page()
    ...
    elif selected_option == "Issue Resolution":
        show_issue_resolution_page()
